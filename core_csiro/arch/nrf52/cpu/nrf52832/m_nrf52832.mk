...
##############################################################################
# NRF52832 Softdevice Sources
##############################################################################

NRF52_SDK_ROOT 					:= $(CORE_EXTERNAL_DIR)/nrf52_sdk
NRF_SOFTDEVICE_DIR  			:= $(NRF52_SDK_ROOT)/components/softdevice/s132
NRF_SOFTDEVICE  				:= $(NRF_SOFTDEVICE_DIR)/hex/s132_nrf52_6.1.1_softdevice.hex
NRF_SOFTDEVICE_BIN				:= $(PLATFORM_LIB_DIR)/$(notdir $(patsubst %.hex, %.bin, $(NRF_SOFTDEVICE)))

$(CSIRO_ARCH_DIR)/cpu/$(CPU_VARIANT)/src/gcc_startup_nrf52.S: $(NRF_SOFTDEVICE_BIN)
