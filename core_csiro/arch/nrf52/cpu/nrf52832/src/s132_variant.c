...
#define VALID_TX_POWER_NUMBER 9
...
/* Supported transmit power levels in dBm for s132 */
static int8_t  pcValidTxPower[VALID_TX_POWER_NUMBER] = { -40, -20, -16, -12, -8, -4, 0, 3, 4 };
static uint8_t ucMaxValidTxPower					 = 4;
static int8_t  cMinvalidTxPower						 = -40;

/*-----------------------------------------------------------*/
// TODO: Replace this and s140_variant.c with a generic roundup function in misc_encoding
